...
export default function UnitCard({ title, description, image, href, number }: UnitCardProps) {
  return (
    <Link href={href} className="group block h-full">
      <div className="surface-card relative h-full overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_16px_28px_rgba(15,118,110,0.14)] flex flex-col">
        {/* Image Section */}
