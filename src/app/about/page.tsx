...
export default function AboutPage() {
  return (
    <div className="bg-white min-h-screen font-sans text-slate-800">
      ...
      {/* Hero — distinct from Home: no logo tile, different title, SDG-led framing */}
      <section className="relative border-b border-slate-200/90 bg-slate-50">
        <div className="absolute inset-x-0 top-0 h-1 flex" aria-hidden>
          <span className="flex-[3] bg-[#4C9F38]" />
          <span className="flex-[3] bg-[#00AED9]" />
          <span className="flex-[2] bg-[#19486A]" />
        </div>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-14 md:pt-20 md:pb-16 text-center">
          <p className="inline-flex items-center gap-2 text-sm text-slate-500 font-medium mb-5">
            <Globe size={16} className="text-teal-700 shrink-0" aria-hidden />
            <span>About interACT · aligned with the UN 2030 Agenda</span>
          </p>
          <h1 className="text-3xl sm:text-4xl lg:text-[2.35rem] font-semibold text-slate-900 tracking-tight leading-snug mb-5">
            Rediscover your core goodness
          </h1>
          <p className="text-base sm:text-lg text-slate-600 leading-relaxed">
            Our curriculum links contemplative skill-building to three Sustainable Development Goals: wellbeing (SDG 3),
            peace through inner stability (SDG 16), and collaboration across communities (SDG 17). Below is how that mapping works — evidence, targets, and delivery.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-sm font-semibold text-blue-600 tracking-wider uppercase mb-3">Strategic Impact</h2>
            <h3 className="text-3xl md:text-4xl font-semibold text-slate-900">Targeting the Goals</h3>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-green-50 to-emerald-50 border border-green-100/50 transition-transform hover:-translate-y-1 hover:shadow-lg">
              <div className="w-16 h-16 bg-[#4C9F38] rounded-xl shadow-lg mb-6 flex items-center justify-center text-white font-semibold text-2xl relative overflow-hidden">
                <Heart className="relative z-10" />
                <div className="absolute inset-0 bg-black/10"></div>
              </div>
              <h4 className="text-xl font-semibold text-slate-900 mb-3">Good Health & Well-being</h4>
              <div className="mb-4">
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-sky-50 to-cyan-50 border border-sky-100/50 transition-transform hover:-translate-y-1 hover:shadow-lg">
              <div className="w-16 h-16 bg-[#00AED9] rounded-xl shadow-lg mb-6 flex items-center justify-center text-white font-semibold text-2xl relative overflow-hidden">
                 <ShieldCheck className="relative z-10" />
                 <div className="absolute inset-0 bg-black/10"></div>
              </div>
              <h4 className="text-xl font-semibold text-slate-900 mb-3">Peace, Justice & Strong Institutions</h4>
              <div className="mb-4">
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-slate-50 to-indigo-50 border border-indigo-100/50 transition-transform hover:-translate-y-1 hover:shadow-lg">
              <div className="w-16 h-16 bg-[#19486A] rounded-xl shadow-lg mb-6 flex items-center justify-center text-white font-semibold text-2xl relative overflow-hidden">
                <Users className="relative z-10" />
                <div className="absolute inset-0 bg-black/10"></div>
              </div>
              <h4 className="text-xl font-semibold text-slate-900 mb-3">Partnerships for the Goals</h4>
              <div className="mb-4">
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-sm font-semibold text-teal-600 tracking-wider uppercase mb-3">The Global Context</h2>
              <h3 className="text-3xl font-semibold text-slate-900 mb-6">Why These Goals Matter Now</h3>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-semibold text-slate-900">1 in 7 Adolescents</h4>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-semibold text-slate-900">59% Eco-Anxiety</h4>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-xl border border-slate-100">
               <h3 className="text-xl font-semibold text-slate-900 mb-6">Methodology & Delivery</h3>
               <p className="text-slate-600 mb-6 text-sm leading-relaxed">
                ...
                <div className="grid grid-cols-2 gap-4">
                   <div className="p-4 bg-teal-50 rounded-xl">
                     <div className="text-3xl font-semibold text-teal-600 mb-1">31%</div>
                   ...
                   <div className="p-4 bg-blue-50 rounded-xl">
                     <div className="text-3xl font-semibold text-blue-600 mb-1">High</div>
      ...
      <section className="py-20 bg-[#2f5f64] relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
             <Link href="/modules" className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-white text-teal-700 font-semibold hover:bg-teal-50 transition-all shadow-lg">
                Start the Curriculum
                <ArrowRight size={20} className="ml-2" />
             </Link>
             <Link href="/team" className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-transparent border border-teal-200 text-white font-semibold hover:bg-teal-600 transition-all">
                Meet the Team
             </Link>
          </div>
        </div>
      ...
      <section className="bg-slate-900 border-t border-slate-800 py-12 text-slate-400">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h4 className="text-sm font-semibold text-slate-300 uppercase tracking-widest">References & Data Sources</h4>
          </div>
