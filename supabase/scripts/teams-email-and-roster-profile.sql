-- =============================================================================
-- INCREMENTAL UPDATE — safe after baseline migrations already ran on Supabase
-- Same logic as: migrations/20260508120000_teams_email_and_profile_role_from_roster.sql
-- Do not edit snapshots/schema-reference.sql for this; run this in SQL Editor.
-- =============================================================================
